							...
							<div class="post">
								...
								<table width="100%" border="1">
									...
									<%
										...
										String query = "select id,name,std,Fromyear,stuid,lan from student where status='Active' order by Fromyear ";
										int i = 3;
									...
									<tr>
										...
										<td><%=rs.getInt(4)%></td>
										<td><a href="ViewStudent.jsp?id=<%=rs.getString(5)%>&lan=<%=rs.getString("lan")%>">View</a>
										</td>
										<td><a href="EditStudent.jsp?id=<%=rs.getString(5)%>&lan=<%=rs.getString("lan")%>">Edit</a>
										</td>
										<td><a href="DeleteStudent?id=<%=rs.getString(5)%>&lan=<%=rs.getString("lan")%>">Delete</a>
										</td>
