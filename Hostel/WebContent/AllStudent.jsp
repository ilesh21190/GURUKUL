					...
					<div id="page-content">
						<div id="content">
							...
							<div class="post">
								...
								<center>
									<p id="deletecon" style="color: red; font-size: 20px">Select
										for Delete...</p>
								</center>
								<table width="100%" border="1">
									<tr class="I18NHeader">
										...
										<th><label class="I18Nmsg"><%=rb.getString("All.status")%></label></th>
									...
									<%
                                                        ...
                                                        String query="select id,name,std,Fromyear,status,stuid,lan from student  order by status,std ";
                                                        int i=3;
                                                            ...
                                                            while(rs.next())
                                                                ...
                                                                %>
																		...
																		<script type="text/javascript">
																				...
																				<%} %>
									<tr>
										<td><label class="I18Nview<%=i%>"><%=rs.getString(2)%></label>
										</td>
										...
										<td><%=rsyear.getInt(1)%></td>
										<%}%>
										<td><label> <%=rs.getString(5)%>
										</label></td>

										<td><a
											href="ViewStudent.jsp?id=<%=rs.getString(6)%>&lan=<%=rs.getString("lan")%>">View</a>
										</td>
										<td><a
											href="EditStudent.jsp?id=<%=rs.getString(6)%>&lan=<%=rs.getString("lan")%>">Edit</a>
										</td>
										<td><a
											href="DeleteStudent?id=<%=rs.getString(6)%>&lan=<%=rs.getString("lan")%>">Delete</a>
										</td>
									</tr>
